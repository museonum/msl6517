...
- rappels séance précédente sur les métadonnées
- identification de catégories d’informations
- nécessité de discrétiser l’information

Modèle conceptuel et leur traduction dans des formats informatiques.

Aborder aujourd’hui des question de modèles de données en sciences de l’information et de la documentation.

Cours qui aura donc un caractère technique relativement marquée, ce dont vous avez probablement déjà pu vous apercevoir avec la lecture de cette semaine.

Pour commencer, il faut être honnête : la partie méthodologique et opérationnelle liée à la recherche d’information et la structuration de données, pas nécessairement ni la plus habituelles pour vous, ni la plus enthousiasmante.

- la production d’un langage documentaire
- recherche avancée dans un SI
- création d’un schéma de bdd

Fait habituellement fuir les étudiants en sciences humaines et sociales.

En dépit du temps passé sur les réseaux sociaux qui laisse souvent penser que les étudiants seraient des digital natives, c’est un problème de littératie numérique. Ceux-ci son souvent incapables d’ouvrir la boîte noire du web et d’appréhenser son fonctionnement. Il en est de même des grands systèmes d’information et de leur structuration en bases de données relationnelles.
